...
import { deleteUser, forgotPassword, loginUser, logoutUser, refreshToken, registerUser, resendOTP, resetPassword, resolveResetCode, updateUser, verifyOTP } from "../controllers/authController";
import { otpResendLimiter } from "../middleware/rateLimiter";
